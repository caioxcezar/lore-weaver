...
// --- Icons ---
import { HeadingOneIcon } from "@/components/TextEditor/tiptap-icons/heading-one-icon";
import { HeadingTwoIcon } from "@/components/TextEditor/tiptap-icons/heading-two-icon";
import { HeadingThreeIcon } from "@/components/TextEditor/tiptap-icons/heading-three-icon";
import { HeadingFourIcon } from "@/components/TextEditor/tiptap-icons/heading-four-icon";
import { HeadingFiveIcon } from "@/components/TextEditor/tiptap-icons/heading-five-icon";
import { HeadingSixIcon } from "@/components/TextEditor/tiptap-icons/heading-six-icon";
